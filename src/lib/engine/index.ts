...
import type { ActivityInput, AuditEntry, CalculationResult, EmissionLineResult, GapItem } from '@/types'
...
export function calculate(request: CalculationRequest): CalculationResult {
  const { organisation_name, reporting_period_start, reporting_period_end, inputs } = request
  ...
  return {
    ...
    lines,
    summary: { total_t_co2e, scope_1_t_co2e, scope_2_t_co2e, scope_3_t_co2e, data_quality_score, estimated_lines, uncertainty_pct },
    gaps,
